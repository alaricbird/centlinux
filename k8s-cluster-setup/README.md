...
Final Verification
After successful playbook execution, you should see:

text
============================================
🚀 KUBERNETES CLUSTER SETUP COMPLETE 🚀
============================================
Control Plane: controlplane.centlinux.com
Worker Nodes: worker01.centlinux.com
CNI: Calico v3.27.0
...
Firewall: Ensure ports 6443, 10250, 10251, 10252 are open

TLS: Certificates are automatically generated by kubeadm

RBAC: Enable RBAC for production (default in newer versions)

Network Policies: Calico provides network policy capabilities
